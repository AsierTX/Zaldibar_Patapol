...
class final_fragment_juego7 : Fragment() {
    ...
    private var mListener: final_fragment_juego7.OnFragmentInteractionListener? = null
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        val view = inflater.inflate(R.layout.fragment_final_juego7, container, false)
    ...
    fun setOnFragmentInteractionListener(listener: final_fragment_juego7.OnFragmentInteractionListener) {
        mListener = listener
    }
}