 ...
 * Use the [inicio_fragment_juego6.newInstance] factory method to
 * create an instance of this fragment.
 */
class inicio_fragment_juego6 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_inicio_juego6, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment inicio_fragment_juego6.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            inicio_fragment_juego6().apply {
    ...
    private fun abrirjuego6() {
        val intent6 = Intent(activity, zaborrajuego::class.java)
