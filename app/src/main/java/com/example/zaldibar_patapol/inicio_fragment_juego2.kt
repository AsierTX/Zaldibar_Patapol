 ...
 * Use the [inicio_fragment_juego2.newInstance] factory method to
 * create an instance of this fragment.
 */
class inicio_fragment_juego2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_inicio_juego2, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment inicio_fragment_juego2.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            inicio_fragment_juego2().apply {
